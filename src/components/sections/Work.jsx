...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: 'A conversion-focused landing page for a smart water bottle: hero product showcase, key features, hydration benefits and a clear call to action, designed end to end.',
